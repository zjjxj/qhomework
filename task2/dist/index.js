...
var _todoList = __webpack_require__(68);

var _todoList2 = _interopRequireDefault(_todoList);

var _todoList3 = __webpack_require__(73);

var _todoList4 = _interopRequireDefault(_todoList3);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var store = (0, _redux.createStore)(_todoList4.default);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(20), __webpack_require__(50)(module)))
...
var _todoList = __webpack_require__(69);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        ...
        onSaveTask: function onSaveTask(task) {
            dispatch({ type: "ADD_TASK", task: task });
        },
        onItemClick: function onItemClick(num) {
            dispatch({ "type": "CLICK_TASK", num: num });
        },
        onDeleteClick: function onDeleteClick(num) {
            dispatch({ "type": "DELETE_TASK", num: num });
        }
    };
};
    ...
    _createClass(TodoList, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_list2.default, { onItemClick: this.props.onItemClick, items: this.props.items,
                    onDeleteClick: this.props.onDeleteClick }),
                _react2.default.createElement(_footer2.default, { onSaveTask: this.props.onSaveTask })
            );
        }
    }]);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                this.props.items.map(function (item, index) {
                    ...
                    return _react2.default.createElement(_item2.default, _extends({ key: index }, item, { onItemClick: _this2.props.onItemClick,
...
var Item = function (_React$Component) {
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            var style = '';
            var deleteBtn = "";
            var contentStyle = _react2.default.createElement(
                'span',
            ...
            if (this.props.finished) {
                ...
                contentStyle = _react2.default.createElement(
                    'span',
                    { className: 'taskContent' },
                    _react2.default.createElement(
                        'del',
            ...
            return _react2.default.createElement(
                'div',
                { className: style, onMouseLeave: this.onMouseLeave.bind(this), onMouseMove: this.onMouseMove.bind(this) },
                _react2.default.createElement(
                    'div',
                    { className: 'row' },
                    _react2.default.createElement(
                        'div',
                        { className: 'col-md-10', id: 'item' },
                        _react2.default.createElement('input', { type: 'checkbox', onClick: this.onItemClick.bind(this), checked: this.props.finished, readOnly: true }),
                        contentStyle
                    ),
                    _react2.default.createElement(
                        'div',
                        ...
                        _react2.default.createElement(
                            'span',
                            { id: 'deleteBtn', onClick: this.onDeleteClick.bind(this) },
                            deleteBtn
                        )
                    )
                )
...
var Footer = function (_React$Component) {
    ...
    _createClass(Footer, [{
        ...
        value: function handleClick() {
            var content = this.refs.textInput.value;
            if (!content) {
                alert("输入不得为空！");
            } else this.props.onSaveTask(content);
        ...
        value: function render() {
            return _react2.default.createElement(
                "div",
                { className: "footer form-horizontal" },
                _react2.default.createElement(
                    "div",
                    ...
                    _react2.default.createElement(
                        "div",
                        { className: "col-md-10" },
                        _react2.default.createElement("input", { className: "form-control", type: "text", placeholder: "\u4F60\u60F3\u505A\u70B9\u4EC0\u4E48", ref: "textInput",
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "div",
                        { className: "col-md-offset-10 col-md-2" },
                        _react2.default.createElement(
                            "button",
...
exports.default = function () {
    ...
    if (action.type === 'ADD_TASK') {
        var task = { "content": action.task, "finished": false, "number": state.items.length };
        return Object.assign({}, state, { items: state.items.concat(task) });
    } else if (action.type === "CLICK_TASK") {
        var arr = Object.assign([], state.items);
        ...
        var _arr = Object.assign([], state.items);
        _arr.splice(action.num, 1);
        ...
        return Object.assign({}, state, { items: _arr });
    }
    return state;
};
